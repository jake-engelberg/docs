...
|--------------------|:--------:|:--------|---------|---------|---------|------------|
| January 6th 2024 | 1.15.0</br>  | 1.15.0 | Java 1.13.1 </br>Go 1.11.0 </br>PHP 1.2.0 </br>Python 1.14.0 </br>.NET 1.14.0 </br>JS 3.4.1 </br>Rust 0.16 | 0.15.0 | Supported (current) | [v1.15.0 release notes](https://github.com/dapr/dapr/releases/tag/v1.15.0) |
